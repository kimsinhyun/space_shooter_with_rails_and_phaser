...
export const PLAYER_MAX_BULLET_COUNT = 10;
...
export const ENEMY_MAX_BULLET_COUNT = 10;
export const ENEMY_BULLET_INTERVAL= 2000;
export const ENEMY_BULLET_SPEED= -280;
export const ENEMY_BULLET_LIFESPAN= 3;
